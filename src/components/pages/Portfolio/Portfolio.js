        ...
        <div className="bg-transparent" style={styles.shadow}>
          ...
          <div className="card-body">
            ...
            <Button
              variant="outline-primary"
              className="d-block mb-2"
              href="https://young-gorge-61076.herokuapp.com/"
              target="_blank"
            >
              On-the-Go Coder Live Demo
            </Button>
            <Button
              variant="outline-light"
              className="d-block"
              href="https://github.com/MaestroLuu/On-the-Go-Coder"
              target="_blank"
            >
              On-the-Go Coder Github Repo
            </Button>
          </div>
        </div>
      </div>
        ...
        <div className="bg-transparent" style={styles.shadow}>
          ...
          <div className="card-body">
            ...
            <Button
              variant="outline-primary"
              className="d-block mb-2"
              href="https://shielded-basin-97663.herokuapp.com/"
              target="_blank"
            >
              Book Marker Live Demo
            </Button>
            <Button
              variant="outline-light"
              className="d-block"
              href="https://github.com/MaestroLuu/Book-Marker"
              target="_blank"
            >
              Book Marker Github Repo
            </Button>
          </div>
        </div>
      </div>
